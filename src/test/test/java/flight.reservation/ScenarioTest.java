...
import flight.reservation.payment.PayPalPaymentFactory;
        ...
        class FlightIsPossible {
            ...
            class H1Empty {
                ...
                void thenTheBookingShouldSucceed() throws NoSuchFieldException {
                    ...
                    PaymentMethodFactory payPalFactory = new PayPalPaymentFactory(customer.getEmail(), "amanda1985");
                    boolean isProcessed = order.processOrderWithPaymentFactory(payPalFactory);
